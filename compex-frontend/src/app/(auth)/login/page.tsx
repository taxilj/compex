      ...
      <div className="w-full md:w-[42%] bg-[#f0f3ff] p-10 flex flex-col justify-center border-b md:border-b-0 md:border-r border-[#E4E7EC]">
        <div className="max-w-sm mx-auto w-full">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <button type="submit" className="w-full bg-[#0B1F3A] text-white py-3 rounded-lg font-label-md hover:bg-[#0B1F3A]/90 transition-colors mt-2">
              Sign In to Dashboard
            </button>

            {/* Demo hint */}
            <div className="bg-[#e8eeff] rounded p-3 text-center">
              <p className="font-body-sm text-[#44474d]">Demo: any email + password → portal</p>
            </div>
          </form>
        ...
        <div className="max-w-xl mx-auto w-full">
          ...
          <form onSubmit={handleRegister} className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="col-span-full">
              <button type="submit" className="w-full bg-[#1769E0] text-white py-3 rounded-lg font-label-md font-bold hover:bg-[#1257b8] transition-colors">
                Create Account
              </button>
            </div>
          </form>
